...
function renderMarketData(entries, notes, windows) {
  ...
  const lines = [
    ...
    "CMP / Intraday % / Daily % use a live quote at generate time (NSE when available, else BSE). Return % always shows 1D, 1W and 1M. ADTV / VWAP / Delivery follow the window checkboxes above.",
  ...
  for (const entry of entries) {
    ...
    const signed = {
      ...
      5: entry.return_1d_pct,
      6: entry.return_1w_pct,
      7: entry.return_1m_pct,
    };
